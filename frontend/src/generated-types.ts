...
export class UpdateBookmarkGQL extends Apollo.Mutation<
...
export class BookmarkGQL extends Apollo.Query<
    BookmarkQuery,
...
export class BookmarksGQL extends Apollo.Query<
    BookmarksQuery,
...
export class CreateBookmarkGQL extends Apollo.Mutation<
